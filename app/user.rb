...
class User < ActiveRecord::Base
    ...
    def my_teams
        if user_has_teams?
            ...
            sleep(1)
            # print save team and player names
    ...
    def vs_computer
        if user_has_teams?
            ...
            #calculate player vs computer
            # chance_of_winning = weighted_stat / (weighted_stat + computer_weighted_stat)
            # random_number = rand(0.0..1.0)

            #puts all the info
            # sleep (1)
            # puts "Here is your teams average: #{average}"
            # puts "Here is the computer's team average: #{computer_average}"
            # puts " "
            # sleep (2)
            # puts "Here is your teams stat: #{team_stats}"
            # puts "Here is the computer's team stat: #{computer_team_stats}"
            # puts " "
            # sleep (2)
            # puts "Here is your weighted team rating: #{weighted_stat}"
            # puts "Here is the computer's weighted team rating: #{computer_weighted_stat}"
            # puts " "
            # sleep (2)
            # puts "*" * 25
            # puts "Your chance of winning against the computer team is: #{(chance_of_winning*100).round(2)}%"
            # sleep(2)

            # #did the user win????
            # puts "hold up we doing maths"
            # sleep (3)
            # # puts random_number
            ...
            determine_winner(average, team_stats, weighted_stat, computer_average, computer_team_stats, computer_weighted_stat)
    ...
    def user_saved_teams
        ...
        user_selected_team = @prompt_my_teams.select("Here are your teams:", team_names, filter: true)
        found_user_selected_team = Team.all.find_by(team_name: user_selected_team, user_id: self.id)
        found_user_team_array = found_user_selected_team.attributes.to_a
        found_user_team_array.shift()
        found_user_team_array.pop()
        found_user_team_array
    ...
    def determine_winner(user_team_avg, user_team_stats, user_weighted_stat, comp_team_avg, comp_team_stats, comp_weighted_stat)
        sleep (1)
        ...
        # sleep(2)
        # puts "The crowd roars and the match begins!".colorize(:black)
        # puts "The crowd roars and the match begins!".colorize(:red)
        puts "The crowd roars and the match begins!".colorize(:green)
        # puts "The crowd roars and the match begins!".colorize(:yellow)
        # puts "The crowd roars and the match begins!".colorize(:blue)
        # puts "The crowd roars and the match begins!".colorize(:magenta)
        # puts "The crowd roars and the match begins!".colorize(:cyan)
        # puts "The crowd roars and the match begins!".colorize(:white)
        # puts "The crowd roars and the match begins!".colorize(:default)
        # puts "The crowd roars and the match begins!".colorize(:light_black)
        # puts "The crowd roars and the match begins!".colorize(:light_red)
        # puts "The crowd roars and the match begins!".colorize(:light_green)
        # puts "The crowd roars and the match begins!".colorize(:light_yellow)
        # puts "The crowd roars and the match begins!".colorize(:light_blue)
        # puts "The crowd roars and the match begins!".colorize(:light_magenta)
        # puts "The crowd roars and the match begins!".colorize(:light_cyan)
        # puts "The crowd roars and the match begins!".colorize(:light_white)
    ...
    def ascii_art(array_of_db_players)
        ...
        # ar_player_initials = ar_player_names.map {|player| p1 = player[1]; p1.split[0][0] + p1.split[-1][0]}
    ...
    def calculate_vs_other_team(user_select_team)
        if user_select_team == 2
            ...
            #present the stats
            self.determine_winner(average, team_stats, weighted_stat, opp_average, opp_team_stats, opp_weighted_stat)
        end
    end
